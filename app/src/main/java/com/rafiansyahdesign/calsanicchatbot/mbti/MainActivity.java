...
import com.rafiansyahdesign.calsanicchatbot.mbti.data.DbHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    RadioGroup rdM;
    RadioButton rdM1,rdM2,rdM3,rdM4,rdM5, rdE1,rdE2,rdE3,rdE4,rdE5, rdN1,rdN2,rdN3,rdN4,rdN5, rdT1,rdT2,rdT3,rdT4,rdT5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rdM=findViewById(R.id.radioGroupM);
        ...
        butNextM.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(qidM<5){
                    ...
                    setContentView(R.layout.activity_mbti2);
                    ...
                    butNextE.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(qidE<5){
                                ...
                                setContentView(R.layout.activity_mbti3);
                                ...
                                butNextN.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if(qidN<5){
                                            ...
                                            setContentView(R.layout.activity_mbti4);
